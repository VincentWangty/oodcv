...
data_root_train='/raid/czn/oodcv/COCO_test/'
...
train_pipeline = [
    ...
    dict(type='MixUp', prob=0.5, lambd=0.8, mixup=True,
       json_path='/raid/czn/oodcv/COCO_jpgjpeg/annotations/instances_trainval_new.json',
       img_path='/raid/czn/oodcv/COCO_jpgjpeg/trainval/'),
    # dict(type='Corrupt', corruption='snow'),
    dict(type='Resize', img_scale=(1333, 800), keep_ratio=True),
    dict(type='RandomFlip', flip_ratio=0.5),
    dict(type='RandomFlip', flip_ratio=0.8, direction='vertical'),
    dict(type='CutOut', n_holes=5, cutout_ratio=(0.3, 0.3), p=1),
    # dict(type='RandomFlip', flip_ratio=0.8, direction='vertical'),
    # dict(
    #     type='Albu',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root_train + 'annotations/instances_trainval_new.json',
        img_prefix=data_root_train + 'trainval/',
