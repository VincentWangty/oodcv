...
def parse_args():
    ...
    parser.add_argument('--checkpoint', help='Checkpoint file', default="/disk2/wty/OOD-CV-COCO/yolov7/runs/train/yolov7-e6/weights/epoch_199.pt")
...
def main(args):
    ...
    PATH = '/disk2/wty/OOD-CV-COCO/data/ROBINv1.1/nuisances/'
    ...
    for i in tqdm(range(len(nuisances))):
        ...
        filename = '/disk2/wty/OOD-CV-COCO/yolov7/runs/train/yolov7-e6/inference_ep199/' + \
                   nuisances[i] + '.json'
        total_files = glob(PATH + nuisances[i] + "/Images/*")
        for j in range(len(total_files)):
            image_path = total_files[j] + '/'
            ...
            for path, img, im0s, vid_cap in dataset:
                ...
                # Apply NMS
                result = non_max_suppression(pred, 0.005, 0.5, classes=args.classes,
